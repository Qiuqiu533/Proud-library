...
# フロントのジャンルボタン9種に対応する紹介文。「特徴」「おすすめの読者」
# 「初めて読むなら」の3項目で構成し、ジャンル一覧の先頭に表示する。
# clusterはPLAM（services/plam.py）のクラスタIDとの対応。PLAMは文学賞
# ネットワークがベースのため、賞のジャンルに直接対応しない児童書・実用書・
# 翻訳小説等はcluster=Noneとし、その場合はBridge Worksコーナーを表示しない。
GENRE_DESCRIPTIONS = {
    "文芸小説": {
        "desc": "芥川賞・直木賞をはじめとする文学賞受賞作を中心に、人間ドラマや社会の断面を丁寧に描く作品が揃っています。",
        "audience": "じっくりと物語に浸りたい方、登場人物の心情の機微を味わいたい方におすすめです。",
        "tip": "まずは受賞作から手に取ると、話題性と読み応えのバランスが取れています。",
        "cluster": "literary",
    },
    "ミステリ・推理": {
        "desc": "謎解き・トリック・サスペンスを軸にした、緊張感のある物語が中心のジャンルです。",
        "audience": "先が気になる展開でページをめくる手が止まらない読書体験が好きな方に。",
        "tip": "本格ミステリ大賞やこのミス大賞の受賞作は、初めての方でも楽しみやすい定番です。",
        "cluster": "mystery",
    },
    "時代小説・歴史小説": {
        "desc": "江戸・幕末・戦国など、日本の歴史を舞台にした人間模様や事件を描く作品です。",
        "audience": "歴史上の出来事や当時の暮らしぶりに興味がある方におすすめです。",
        "tip": "実在の人物が登場する作品から入ると、歴史の背景も一緒に楽しめます。",
        "cluster": None,
    },
    "ファンタジー・SF": {
        "desc": "異世界・魔法・未来技術など、現実とは異なる世界観を舞台にした作品が集まっています。",
        "audience": "想像力を刺激する物語や、日常から離れた読書体験を求める方に。",
        "tip": "SF大賞受賞作は科学的な発想と物語性のバランスが取れており入門にも向いています。",
        "cluster": "sf",
    },
    "実用・ハウツー": {
        "desc": "健康・料理・仕事術・自己啓発など、日々の暮らしや仕事に役立つ知識をまとめた本です。",
        "audience": "具体的な悩みの解決法やすぐ実践できるヒントを探している方におすすめです。",
        "tip": "気になるテーマから1冊選んで、実際に試してみるのがおすすめです。",
        "cluster": None,
    },
    "翻訳小説": {
        "desc": "海外文学の翻訳作品を集めたジャンルです。国や時代を超えた物語に触れられます。",
        "audience": "異なる文化や価値観に触れたい方、世界的な話題作を読みたい方に。",
        "tip": "映画化・ドラマ化された作品から入ると物語に入りやすいです。",
        "cluster": None,
    },
    "エッセイ・評論": {
        "desc": "著者自身の経験や考えを綴ったエッセイ、社会や文化を論じる評論をまとめたジャンルです。",
        "audience": "著者の視点や語り口を楽しみたい方、物事を多角的に考えたい方におすすめです。",
        "tip": "気になる著者や興味のあるテーマから選ぶと読みやすいです。",
        "cluster": None,
    },
    "絵本・児童書": {
        "desc": "小さなお子さんから楽しめる絵本や、読み聞かせに向いた作品を集めています。",
        "audience": "お子さんと一緒に読書の時間を楽しみたいご家庭におすすめです。",
        "tip": "年齢や興味に合わせて、絵の雰囲気で選ぶのもおすすめです。",
        "cluster": None,
    },
    "児童文学": {
        "desc": "小中学生を主な読者として書かれた物語で、成長や友情をテーマにした作品が中心です。",
        "audience": "お子さんの読書習慣づくりや、親子で同じ本について話したい方に。",
