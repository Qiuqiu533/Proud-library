...
3. 以下の3要素を必ず含める:
   ...
   ② 読みどころ・魅力（なぜ面白いか）
   ③ 対象読者（誰に向いているか）
4. 1文は60字以内に収める（長い文は2文に分ける）
5. 著者・ジャンルから推測できる内容は積極的に書いてよい
6. 推測する場合は「〜と思われます」ではなく「〜だろう」「〜といえる」と自然な文体で
7. 特定の政治・宗教・思想的立場を推奨・批判しない
8. 最後に自己採点スコア（0〜100点）を付ける（基準：文字数400字以上=+20、3要素含む=+30、読者を引き付ける文体=+30、事実の正確性=+20）
