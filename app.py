...
ADMIN_PASSWORD   = os.environ.get("ADMIN_PASSWORD",   "[REDACTED-4]")
RESIDENT_PASSWORD = os.environ.get("RESIDENT_PASSWORD", "[REDACTED-2]")
BOARD_PASSWORD   = os.environ.get("BOARD_PASSWORD",   "[REDACTED-5]")
